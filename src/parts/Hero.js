                ...
                <div className="col-auto pr-5" style={{ width: 450 }}>
                    ...
                    <div className="row mt-5">
                        <div className="col-auto">
                            <img src={IconTraveler} alt={`${props.data.travelers} Travelers`}></img>
                            <h6 className="mt-3">
                                {props.data.travelers} <span className="text-gray-500 font-weight-light">Travelers</span>
                            </h6>
                        </div>
                        <div className="col-auto">
                            <img src={IconCities} alt={`${props.data.cities} Cities`}></img>
                            <h6 className="mt-3">
                                {props.data.cities} <span className="text-gray-500 font-weight-light">Cities</span>
                            </h6>
                        </div>
                        <div className="col-auto">
                            <img src={IconTreasure} alt={`${props.data.treasure} Treasure`}></img>
                            <h6 className="mt-3">
